...
record.setdefault("guard_91_refresh", dict(
    previous_after_sha256=record["after_sha256"],
    previous_after_totals=record["after_totals"],
    reason="Clarify manual replay and evidence-set durability; retain actual unrefreshed-edit stdout; membership unchanged.",
))
