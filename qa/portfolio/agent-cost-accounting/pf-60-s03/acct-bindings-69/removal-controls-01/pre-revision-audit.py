...
for file in sorted(run.glob("*-selected.json")):
    ...
    if subtotal:
        amount = expected if known else Decimal(0)
...
with output.open("x") as file:
    ...
    file.write("\n")
print(f"{len(numeric_pages)} numeric pages independently checked; six reader states covered with explicit limitations")
