#!/usr/bin/env bash
set -euo pipefail
repo=/home/travis/worktrees/security-broker-resume-20260911
evidence=/home/travis/security-round5/evidence/pf27-resume-20260911
mkdir -p "$evidence"
...
export TMPDIR
TMPDIR=$(mktemp -d /home/travis/.pf27.XXXXXX)
cd "$repo"
