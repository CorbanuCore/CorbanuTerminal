...
export PF27_PAIR_REPO=/home/travis/worktrees/security-broker-system-preflight-20260913
...
proof=/home/travis/security-round5/evidence/pf27-system-preflight-20260913
export PF27_EVIDENCE_DIR="$proof/final-tmux"
test -n "${TMUX:-}"
test "$(id -u)" = 1001
mkdir "$proof/final-started-19f662493"
cd "$PF27_PAIR_REPO"
test "$(git rev-parse HEAD)" = 19f6624938c53e0c9709e1b25ada4a44fd13267e
test "$(git rev-parse HEAD:codex-rs)" = 09f72396304d80a82cf466e220378f763ea8313b
...
test -z "$(git status --porcelain)"
test "$result" = 0
printf 'PF27_SYSTEM_PREFLIGHT_19F662493_COMPLETE\n'
