...
export PF27_PAIR_REPO=/home/travis/worktrees/security-broker-preflight-receiving-c51d2d6aa
...
proof=/home/travis/security-round5/evidence/pf27-preflight-receiving-c51d2d6aa
export PF27_EVIDENCE_DIR="$proof/final-tmux"
test -n "${TMUX:-}"
test "$(id -u)" = 1001
mkdir "$proof/final-started-c51d2d6aa"
cd "$PF27_PAIR_REPO"
test "$(git rev-parse HEAD)" = c51d2d6aa76da780868bcf83c2738a6c0149a73c
test "$(git rev-parse HEAD:codex-rs)" = dc3ce10ff45c20c371db67b7b75e2b2317b31165
test "$(git rev-parse HEAD:codex-rs/Cargo.lock)" = ded15fd917dc517b933c0a637821d28f9e3300ba
...
result=0
bash qa/security-levels/sprints/PF-27-S04/system-preflight-20260913/qualify-rtx.sh > "$proof/suite.log" 2>&1 || result=$?
...
test -z "$(git status --porcelain)"
test "$result" = 0
printf 'PF27_PREFLIGHT_RECEIVING_C51D2D6AA_COMPLETE\n'
