...
repo = Path('/home/travis/worktrees/security-broker-root-composition-20260912')
evidence = Path(os.environ.get('PF27_EVIDENCE_DIR', '/home/travis/security-round5/evidence/pf27-root-composition-20260912/verified'))
...
with tempfile.TemporaryDirectory(prefix='.pf27c-', dir='/home/travis') as temp:
    ...
    def wait_for(marker):
        ...
        while time.monotonic() < deadline:
            pane = tmux('capture-pane', '-p', '-S', '-', '-t', 'children:0.0').stdout
    ...
    try:
        ...
        assert '17 tests run: 17 passed' in lifecycle
