#!/usr/bin/env bash
set -euo pipefail
repo=/home/travis/worktrees/security-broker-manifest-20260912
evidence=${PF27_EVIDENCE_DIR:-/home/travis/security-round5/evidence/pf27-manifest-20260912/initial}
mkdir -p "$evidence"
...
export TMPDIR
TMPDIR=$(mktemp -d /home/travis/.pf27m.XXXXXX)
cd "$repo"
