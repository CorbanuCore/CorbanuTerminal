#!/usr/bin/env bash
set -euo pipefail
repo=/home/travis/worktrees/security-broker-launch-20260912
evidence=${PF27_EVIDENCE_DIR:-/home/travis/security-round5/evidence/pf27-launch-20260912/verified}
mkdir -p "$evidence"
...
export TMPDIR
TMPDIR=$(mktemp -d /home/travis/.pf27l.XXXXXX)
cd "$repo"
