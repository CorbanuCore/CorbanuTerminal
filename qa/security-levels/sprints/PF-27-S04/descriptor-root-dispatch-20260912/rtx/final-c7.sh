...
export PF27_PAIR_REPO=/home/travis/worktrees/security-broker-root-dispatch-20260912
...
proof=/home/travis/security-round5/evidence/pf27-root-dispatch-20260912
export PF27_EVIDENCE_DIR="$proof/final-tmux"
test -n "${TMUX:-}"
test "$(id -u)" = 1001
mkdir "$proof/final-started-c7"
cd "$PF27_PAIR_REPO"
test "$(git rev-parse HEAD)" = c7d48e4822293ec0899311be63fbd08848516ba0
test "$(git rev-parse HEAD:codex-rs)" = bd56b597e348d2924da21706c594c20a868bace4
...
result=0
bash qa/security-levels/sprints/PF-27-S04/descriptor-root-dispatch-20260912/qualify-rtx.sh > "$proof/suite.log" 2>&1 || result=$?
...
test -z "$(git status --porcelain)"
test "$result" = 0
printf 'PF27_ROOT_DISPATCH_C7D48E482_COMPLETE\n'
