...
cd "$PF27_PAIR_REPO"
test "$(git rev-parse HEAD)" = a1e0ff9549f90919562f6d881dc3a577413bba11
test "$(git rev-parse HEAD:codex-rs)" = 1c6972f55f02121f37096e945df3e635bb223532
...
test -z "$(git status --porcelain)"
test "$result" = 0
printf 'PF27_ROOT_DISPATCH_A1E0FF954_COMPLETE\n'
