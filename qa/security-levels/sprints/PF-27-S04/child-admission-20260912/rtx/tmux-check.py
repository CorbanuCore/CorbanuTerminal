...
evidence = Path('/home/travis/security-round5/evidence/pf27-child-admission-20260912')
...
with tempfile.TemporaryDirectory(prefix='.pf27c-', dir='/home/travis') as temp:
    ...
    try:
        ...
        assert '11 tests run: 11 passed' in lifecycle
        ...
        (evidence / 'tmux-result.json').write_text(json.dumps({
            'passed': True, 'tests': 11, 'production_exit': 78,
