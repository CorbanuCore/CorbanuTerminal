...
task_package=$task_runtime/macos-candidate-blind-repairs-20260910
task_build=$task_runtime/macos-target/release
# Immutable earlier package supplies unchanged resources; replace every executable.
test ! -e "$task_package"
cp -a "$task_runtime/macos-candidate-picker-final-20260910" "$task_package"
