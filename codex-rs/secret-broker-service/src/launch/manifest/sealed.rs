...
/// Sealed bytes whose narrow ELF profile was inspected, not safe-to-run approval.
/// Keeps the same private image and recipe; no Clone, descriptor export or exec.
pub struct SyntheticProfileInspectedImage {
