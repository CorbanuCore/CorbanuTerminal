...
impl ChatWidget {
    ...
    pub(super) fn new_with_op_target(
        ...
        let mut widget = Self {
            ...
            campaign_tracker_turn: None,
            campaign_tracker_indicator: None,
            campaign_tracker_automated_input: false,
            campaign_tracker_syncing: false,
            campaign_tracker_vault: Default::default(),
            campaign_tracker_stores: Default::default(),
            tasknode_menu_counts: None,
            tasknode_menu_poll_generation: 0,
            tasknode_response_generations: HashMap::new(),
            ...
            pending_provider_api_key_save_id: None,
