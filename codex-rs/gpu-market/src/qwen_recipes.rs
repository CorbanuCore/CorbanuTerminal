...
pub(crate) fn qwen_3_8_flash_next_fp8_b300_recipe() -> GpuRecipe {
    GpuRecipe {
        id: "qwen3.8-flash-next-fp8-2xb300-experimental".to_string(),
        revision: "qwen38-flash-next-fp8-vllm-dedicated-20260827-2xb300-r1".to_string(),
        model_id: "Qwen/Qwen3.8-Flash-Next-FP8".to_string(),
        served_model_id: "Qwen/Qwen3.8-Flash-Next-FP8".to_string(),
        wire_api: "chat".to_string(),
        model_revision: "970c569adaca6b35532111fd6b27351b2baefe50".to_string(),
        image: "vllm/vllm-openai@sha256:0aea30240f3e3d9ffae8526643950e170eb5fa07fc427016a9dd90892afa2aa3"
            .to_string(),
        runtime: "vllm".to_string(),
        serving_runtime_version:
            "qwen38-flash-next@sha256:0aea30240f3e3d9ffae8526643950e170eb5fa07fc427016a9dd90892afa2aa3"
                .to_string(),
        license_id: "Apache-2.0".to_string(),
        requires_huggingface_token: false,
        ...
        maximum_context_tokens: 262_144,
        maximum_concurrent_requests: 256,
        expected_download_bytes: 185_523_317_458,
        model_weight_bytes: 185_523_317_458,
        kv_cache_reserve_bytes: 250_000_000_000,
        workspace_reserve_bytes: 64_000_000_000,
        launch_command: vec![
            "bash".to_string(),
            "-lc".to_string(),
            concat!(
                ...
                "pft_phase runtime_setup; vllm --version; ",
                "printf 'PFTERMINAL_RUNTIME_GATE=runtime-ok\n'; pft_phase model_download; ",
                "VLLM_ENGINE_READY_TIMEOUT_S=7200 vllm serve Qwen/Qwen3.8-Flash-Next-FP8 ",
                ...
                "--reasoning-parser qwen3 --api-key \"$PFT_ENDPOINT_TOKEN\" & server_pid=$!; ",
                "trap 'kill \"$server_pid\" 2>/dev/null || true' TERM INT EXIT; ",
                "for i in $(seq 1 3600); do kill -0 \"$server_pid\"; ",
                "pft_model_ready && break; sleep 2; done; kill -0 \"$server_pid\"; ",
                "pft_model_ready; printf 'PFTERMINAL_RUNTIME_GATE=server-ok\n'; ",
        ...
        probe_deadline_ms: 20 * 60 * 1_000,
        inference_port: 8000,
        chat_encoding: "qwen3.8-flash-next-tokenizer-template".to_string(),
        probe_contract: "pfterminal-openai-v1".to_string(),
        stability: RecipeStability::Experimental,
        manifest_verified: true,
    }
