---
sprint_id: "PF-04-S10"
title: "Provider health and same-role failover"
status: cancelled
...
depends_on: "PF-04-S09"
created: 2026-08-23
updated: 2026-08-24
---

# PF-04-S10 — Provider health and same-role failover

## Execution mandate

- Deliver: Fail over only between adapters qualified for the same logical role and profile.
...
- Acceptance advanced: Fail over only between adapters qualified for the same logical role and profile.
...
- [ ] Dependencies are completed: `PF-04-S09`.
...
- [ ] Define health probe, circuit state, retry budget, backoff, and recovery transitions.
- [ ] Emit a visible route-change event without exposing credentials or sensitive query text.
- [ ] Prove search never fails over to fetch, interactive browser, native bypass, or host browser.
