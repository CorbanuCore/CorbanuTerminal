...
depends_on: "PF-03-S02"
created: 2026-08-23
updated: 2026-08-24
---

# PF-03-S03 — Isolated fetch adapter

## Execution mandate

- Deliver: Route eligible HTTPS page reads into the retriever and return bounded extraction output.
...
- Acceptance advanced: Route eligible HTTPS page reads into the retriever and return bounded extraction output.
...
- [ ] Dependencies are completed: `PF-03-S02`.
...
- [ ] Define typed fetch request, timeout, size, content-type, and redirect budgets.
- [ ] Connect the adapter to the isolated workload without exposing a browser-control handle.
- [ ] Return source metadata and bounded content for later provenance and classification.
