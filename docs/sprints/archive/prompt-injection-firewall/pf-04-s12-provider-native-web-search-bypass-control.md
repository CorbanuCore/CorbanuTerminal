---
sprint_id: "PF-04-S12"
title: "Provider-native web_search bypass control"
status: cancelled
...
depends_on: "PF-04-S11"
created: 2026-08-23
updated: 2026-08-24
---

# PF-04-S12 — Provider-native web_search bypass control

## Execution mandate

- Deliver: Disable native search paths that cannot be screened before main-model ingestion.
...
- Acceptance advanced: Disable native search paths that cannot be screened before main-model ingestion.
...
- [ ] Dependencies are completed: `PF-04-S11`.
...
- [ ] Identify native ToolSpec::WebSearch exposure for each model-provider translation.
- [ ] Under Moderate/Aggressive, suppress or deny native tools unless output returns through the broker.
- [ ] Add tool-plan and request-body regressions proving no parallel unscreened search path remains.
