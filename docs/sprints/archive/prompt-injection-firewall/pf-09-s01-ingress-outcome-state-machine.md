---
sprint_id: "PF-09-S01"
title: "Ingress outcome state machine"
status: cancelled
...
# PF-09-S01 — Ingress outcome state machine

## Execution mandate

- Deliver: Implement allow, sanitize-and-rescan, quarantine, and reject transitions.
...
- Acceptance advanced: Implement allow, sanitize-and-rescan, quarantine, and reject transitions.
...
- [ ] Define valid transitions, terminal states, reason codes, and security-level thresholds.
- [ ] Bind each outcome to source, content, transform, and classifier digests.
- [ ] Reject repeated sanitization, missing verdicts, stale decisions, and outcome mutation.
