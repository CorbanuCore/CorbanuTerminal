...
| --- | --- | ---: | --- |
| [P0 `/security` levels](../plans/active/p0-security-levels.md) | Active | [59 current sprints](current/p0-security-levels/index.md), 17 completed archives | PF-27-S03 is in progress in the foundation/platform lane; PF-34-S04 is completed and archived; PF-13-S07 retains final composed qualification |
