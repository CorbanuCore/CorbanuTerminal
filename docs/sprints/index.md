...
| [Unified provider onboarding and management](../plans/active/unified-provider-auth.md) | Active | [9 current sprints](current/unified-provider-auth/index.md), 6 inherited completed Claude archives | PF-48-S01 is in progress with the serial GPT-5.6 Sol high implementation owner; Codex primary owns integration, substantial TMUX qualification, and the four-review ceiling |
