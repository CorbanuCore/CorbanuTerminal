...
| [Unified provider onboarding and management](../plans/active/unified-provider-auth.md) | Active | [6 current sprints](current/unified-provider-auth/index.md), 9 completed archives including the inherited Claude foundation | PF-50-S01 is implemented, primary-accepted, and archived at `6f90e89792`; PF-51 remains draft and unallocated |
