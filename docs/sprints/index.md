...
| [Reliable Claude subscription authentication](../plans/active/claude-subscription-auth.md) | Active | [1 current sprint](current/claude-subscription-auth/index.md), 5 completed archives | PF-47-S01 corrects first-run Anthropic-account onboarding; named human/live-account, live-repository, physical release-host, and release gates remain open on the plan |
