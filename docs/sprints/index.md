...
| [Unified provider onboarding and management](../plans/active/unified-provider-auth.md) | Active | [1 current sprint](current/unified-provider-auth/index.md) | PF-55-S03 repairs live Astra client compatibility and requires real TUI inference/tool evidence |
