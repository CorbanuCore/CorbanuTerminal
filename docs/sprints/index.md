...
| [Unified provider onboarding and management](../plans/active/unified-provider-auth.md) | Active | [5 current sprints](current/unified-provider-auth/index.md), 10 completed archives including the inherited Claude foundation | PF-51-S01 is implemented, primary-accepted, and archived at `13dcc188fb`; PF-52 remains draft and unallocated |
