...
| [Unified provider onboarding and management](../plans/active/unified-provider-auth.md) | Active | [4 current sprints](current/unified-provider-auth/index.md), 11 completed archives including the inherited Claude foundation | PF-52-S01 is integrated and archived; PF-53-S01 is next and unallocated |
