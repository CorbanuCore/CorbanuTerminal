...
| [Unified provider onboarding and management](../plans/active/unified-provider-auth.md) | Active | [8 current sprints](current/unified-provider-auth/index.md), 7 completed archives including the inherited Claude foundation | PF-49-S01 owns the serial GPT-5.6 Sol high implementation lane; Codex primary owns integration and the initiative review ceiling |
