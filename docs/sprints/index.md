...
| [Unified provider onboarding and management](../plans/active/unified-provider-auth.md) | Active | [7 current sprints](current/unified-provider-auth/index.md), 8 completed archives including the inherited Claude foundation | PF-49-S01 is implemented, primary-accepted, and archived at `5fcde1c1d9`; PF-50 remains draft and unallocated |
