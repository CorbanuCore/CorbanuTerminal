...
| --- | --- | ---: | --- |
| [P0 `/security` levels](../plans/active/p0-security-levels.md) | Active | [60 current sprints](current/p0-security-levels/index.md), 16 completed archives | PF-13-S05 and PF-33-S03 are archived; PF-13-S07 retains final composed qualification and current sprints are draft pending checked allocation |
