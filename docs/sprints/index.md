...
| [Reliable Claude subscription authentication](../plans/active/claude-subscription-auth.md) | Active | [0 current sprints](current/claude-subscription-auth/index.md), 5 completed archives | Automated delivery is qualified; named human/live-account, live-repository, physical release-host, and release gates remain open on the plan |
