...
| [Unified provider onboarding and management](../plans/active/unified-provider-auth.md) | Active | [1 current sprint](current/unified-provider-auth/index.md), 15 completed archives including the inherited Claude foundation | PF-48–PF-56 are archived; PF-57-S01 is allocated for latest-main integration and combined-tree qualification |
