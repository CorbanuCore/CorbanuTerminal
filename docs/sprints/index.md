...
| --- | --- | ---: | --- |
| [P0 `/security` levels](../plans/active/p0-security-levels.md) | Active | [60 current sprints](current/p0-security-levels/index.md), 16 completed archives | PF-27-S03 is ready in the foundation/platform lane; PF-13-S07 retains final composed qualification |
