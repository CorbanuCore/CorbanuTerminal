...
foundation. PF-48 is completed and archived; PF-49 now owns the serial
implementation lane.
...
| 8 | [PF-49-S01](pf-49-s01-status-and-eligibility.md) | Shared metadata status and eligibility persistence | in progress | PF-48-S01 |
