...
integration_gate: "Manager allocates24 worker paths for review02 redirect correction, including four exact login/HTTP builder paths; combined27-path3900/1450 ceiling under anthropic-dispatch-allocation.md. Manager-only dependency/lock ownership unchanged. Preserve OFF headers/UA/cookies/proxy/sandbox/CA policy; accounted redirects never follow or reenable via fallback. Review03 remaining, prior history and two-cycle convergence preserved. Actual native307/308 proof plus affected Core/API/login/http-client tests required; full-Core133 baseline-matched failures remain non-clean. No live or human-ready claim."
