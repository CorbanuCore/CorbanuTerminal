...
- [ ] Correct production deletion time sampling after main-state writer lock; preserve explicit test timestamps and add real reordered-operation regression. First two P2s corrected with286 state tests; remaining review13225 P2 is not accepted. Manager2150/1000 bounded allowance and next corrective review recorded in allocation addendum.
