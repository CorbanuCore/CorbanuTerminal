...
- Deliver: qa/portfolio/agent-cost-accounting/qualification.md; All cost flows pass on one recorded binary; unknown/estimated values remain visibly distinct.
...
- Planned output: `qa/portfolio/agent-cost-accounting/qualification.md`; no edits outside the allocated scope.
- Tests/evidence: `qa/portfolio/agent-cost-accounting/pf-60-s04/` (planned); final literal test/registration scope required before readiness.
...
- [ ] Build the final candidate and run three-provider parent/child journeys with synthetic usage and one authorized live-provider check.
- [ ] Exercise cancellation, missing price, duplicate retry, restart/resume and historical inspection using actual keys.
- [ ] Reconcile against golden totals, repeat applicable live-repo workflows, obtain named human acceptance and document only verified behavior.
- [ ] Record actual outputs, counterexamples, remaining limitations and a concrete next-sprint handoff; stop on changed scope.

## Verification

- [ ] Focused: From codex-rs: CORBANU_TMUX_REQUIRED=1 just test -p codex-tui --test all tmux --retries 0
