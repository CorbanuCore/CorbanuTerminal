...
- [ ] Independently receive and functionally qualify S03-C range/grouping controls, requested/effective UTC coverage, invalid-range refusals and partial-bucket exclusion; implementation is recorded in Done.
