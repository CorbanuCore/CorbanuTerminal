...
## Remaining
- [ ] Fable reissues S03-A with a scope-safe formatting/fix procedure; finish the complete vertical unit and its 34 tests. The retained draft is not approved, compiled or tested and cannot be treated as a substitute delivery.
