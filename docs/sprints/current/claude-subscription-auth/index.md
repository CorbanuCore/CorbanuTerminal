...
allows one serial sprint. CSA-01 through CSA-05 are completed and archived.
CSA-06 corrects the first-run integration gap found during human acceptance.
...
| 6 | [CSA-06 / PF-47-S01](pf-47-s01-first-run-anthropic-account.md) | First-run Anthropic-account onboarding | in progress | PF-46-S01 |
