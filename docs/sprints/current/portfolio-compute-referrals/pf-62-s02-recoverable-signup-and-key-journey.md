---
sprint_id: "PF-62-S02"
title: "Recoverable signup and key journey"
status: draft
...
depends_on: "PF-62-S01"
created: 2026-09-09
updated: 2026-09-09
---

# PF-62-S02 — Recoverable signup and key journey

## Execution mandate

- Deliver: docs/research/compute-referrals/journey.md; Each failure has a reachable next action and a test checkpoint; no new auth subsystem is proposed.
...
- Feature: `PF-62`; acceptance: Each failure has a reachable next action and a test checkpoint; no new auth subsystem is proposed.
...
- Planned output: `docs/research/compute-referrals/journey.md`; no edits outside the allocated scope.
- Tests/evidence: `qa/portfolio/compute-referrals/pf-62-s02/` (planned); final literal test/registration scope required before readiness.

## Preconditions

- [ ] Plan active after explicit authority decision; global WIP and occupied lanes reconciled.
- [ ] Dependencies completed and archived; Accepted PF-62-S01 output and its explicit go/no-go; no unresolved decision that changes this mandate.
...
- [ ] Map website discovery, explicit referral disclosure, provider signup, credential enrollment, first task and stop/termination.
- [ ] Specify cancel, invalid/expired credential, provider outage, budget exhaustion and lost-session recovery using existing auth/vault ownership.
- [ ] Prepare mock-screen and actual-key test scripts; ban secret copy-through-chat and hidden file-edit recovery.
- [ ] Record actual outputs, counterexamples, remaining limitations and a concrete next-sprint handoff; stop on changed scope.

## Verification

- [ ] Focused: Tabletop all failure paths as a user with only documented controls.
