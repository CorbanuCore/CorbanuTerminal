...
- [x] True-TUI `/model` verification on `ce22ea31d9` opened directly on `Corbanu API` and rendered the exact six public routes from GLM 5.3 Flash through DeepSeek V4 Pro, with no legacy Ambient or Direct rows; installed binary SHA-256 is `81140c189e4e0c33de0e057692a6432b37447f23eee302ed4ea17896ea2cc6c6`, with trace log at `/tmp/corbanu-model-picker-qa.DjpcKI/codex-tui.log`.
