...
depends_on: "PF-04-S04"
created: 2026-08-23
updated: 2026-08-23
---

# PF-04-S05 — Brave Search adapter

## Execution mandate

- Deliver: Implement Brave Search behind the provider contract.
...
- Acceptance advanced: Implement Brave Search behind the provider contract.
...
- [ ] Dependencies are completed: `PF-04-S04`.
...
- [ ] Resolve the Brave credential by reference inside the request executor.
- [ ] Map supported query filters without provider-specific agent tools.
- [ ] Normalize results and test hostile snippets, quota, timeout, auth, and response drift.
