---
sprint_id: "PF-01-S03"
title: "Vault credential-reference API"
status: draft
...
depends_on: "PF-01-S02"
created: 2026-08-23
updated: 2026-08-23
---

# PF-01-S03 — Vault credential-reference API

## Execution mandate

- Deliver: Expose opaque scoped credential references instead of vault values.
...
- Acceptance advanced: Expose opaque scoped credential references instead of vault values.
...
- [ ] Dependencies are completed: `PF-01-S02`.
...
- [ ] Define opaque reference id, capability scope, actor, expiry, and revocation fields.
- [ ] Add vault create, resolve-metadata, revoke, and expiry APIs that never return values to model callers.
- [ ] Test enumeration denial, forged ids, expired ids, and adjacent-scope reuse.
