---
sprint_id: "PF-73-S02"
title: "Blinded exact-model comparison"
status: draft
...
depends_on: "PF-73-S01"
created: 2026-09-09
updated: 2026-09-09
---

# PF-73-S02 — Blinded exact-model comparison

## Execution mandate

- Deliver: docs/research/text-improvement/comparison.md; A preferred variant passes every critical fidelity gate; unavailable routes remain unavailable, not inferred.
...
- Feature: `PF-73`; acceptance: A preferred variant passes every critical fidelity gate; unavailable routes remain unavailable, not inferred.
...
- Planned output: `docs/research/text-improvement/comparison.md`; no edits outside the allocated scope.
- Tests/evidence: `qa/portfolio/text-improvement/pf-73-s02/` (planned); final literal test/registration scope required before readiness.

## Preconditions

- [ ] Plan active after explicit authority decision; global WIP and occupied lanes reconciled.
- [ ] Dependencies completed and archived; Accepted PF-73-S01 output and its explicit go/no-go; no unresolved decision that changes this mandate.
...
- [ ] Compare the current harness with explicitly approved Fable 5.1 and/or Astra routes only after confirming availability and sample disclosure consent.
- [ ] Record model/provider/prompt, cost, latency, failures and blinded editorial judgments; do not substitute a model.
- [ ] Test cancel, malformed output and revert; keep raw originals separate from model edits.
- [ ] Record actual outputs, counterexamples, remaining limitations and a concrete next-sprint handoff; stop on changed scope.

## Verification

- [ ] Focused: Re-score anonymized outputs and inspect every changed factual statement against the source.
