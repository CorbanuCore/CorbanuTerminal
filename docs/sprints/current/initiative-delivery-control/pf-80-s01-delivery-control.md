...
integration_gate: "Real-Slack7worker/10manager scope. Review04 P1 classified: only lifetime-lock/session-lease lifecycle correction authorized by slack-live-allocation.md; worker2600/1100, parent650/500, combined3250/1600 and one changed-candidate review. Preserve225tests, all prior failures/limits. No quarantine/recovery-send/migration engine; missing-fence recovery remains manager pre-live work. Shared registration unaccepted staging. Combined Python/Node/governance and actual identity/HTTPS/phone/restart/CAS/native ACK required; live OFF."
