...
## Remaining
- [ ] `D06` remains open and is the same unknown-gap-as-zero class as D03, found independently once its fixture actually established permission denial. Two cases catching one class from different angles is convergent evidence rather than duplication; the D03 fix needs re-running against D06 to confirm it covers both.
