...
## Remaining
- [ ] Implement receiving-owner-allocated [single-child lifecycle](../../../../qa/security-levels/sprints/PF-27-S04/descriptor-owner-next-20260912.md): private Reservation/LaunchHandle/status API, sealed-image fixed-recipe check, precreated worker, cancellation/deadline/drop CleanupPending and retained permit until observed cleanup. Deterministic failure/recovery plus real RTX/TMUX proof and Astra/Fable closeout required; no adapter semantics/children.rs/PF20/native/main expansion.
