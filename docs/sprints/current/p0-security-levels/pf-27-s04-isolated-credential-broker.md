...
## Remaining
- [ ] Separately allocate exec binding/loader trust/spawn/supervision after sealed-image construction, before listener/client wiring. Preserve identity/group/FD/Child rules and bounded resource handling; exact privileged installation approval and native qualification remain required.
