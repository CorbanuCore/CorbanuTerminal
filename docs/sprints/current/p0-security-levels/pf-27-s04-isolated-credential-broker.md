...
## Remaining
- [ ] Finish [static-probe feasibility](../../../../qa/security-levels/sprints/PF-27-S04/static-probe-next-20260912.md): retain initial101/OpenSSL2 and run approved private UAPI completion/retry, no graph changes, weakened checks or invocation. Then separately allocate exec/loader trust/supervision with existing identity/group/FD/Child/resource/privileged/native gates.
