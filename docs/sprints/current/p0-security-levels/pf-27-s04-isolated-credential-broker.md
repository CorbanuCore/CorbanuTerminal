...
- [ ] Separately agree the runtime ELF/static-dependency contract and allocate exec/loader trust/supervision; preserve identity/group/FD/Child, resource bounds and exact privileged/native gates. Build-only static feasibility is not execution or release-strategy approval.
