...
- [ ] Implement the receiving-owner-accepted [manifest/executable inspection](../../../../qa/security-levels/sprints/PF-27-S04/manifest-next-20260912.md) boundary. Actual spawn/exec binding/loader trust/supervision and listener/client remain later allocations. Preserve identity/group/FD/Child rules; no privileged installation or full PF27 completion.
