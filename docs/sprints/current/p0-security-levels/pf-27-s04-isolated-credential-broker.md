...
## Remaining
- [ ] Finish accepted [static-probe feasibility](../../../../qa/security-levels/sprints/PF-27-S04/static-probe-next-20260912.md): retain initial101 and run one approved private static-OpenSSL retry, no graph changes or invocation. Then separately allocate exec/loader trust/supervision, preserving identity/group/FD/Child, resource bounds and exact privileged/native gates.
