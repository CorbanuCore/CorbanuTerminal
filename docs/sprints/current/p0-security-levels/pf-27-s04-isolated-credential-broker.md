...
## Remaining
- [ ] Execute [Stage B allocation](../../../../qa/security-levels/sprints/PF-27-S04/descriptor-admission-allocation-20260912.md): seven paths/measured863/hard900; review30 buffered-EOF P2 narrowly lifts runtime freeze. Finish31, failing regression then repair/fullproof, corrective Fable32 authorized. Preserve originals; later user/PF26 policy1.7 isolation, no activation.
