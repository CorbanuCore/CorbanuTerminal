...
## Remaining
- [ ] Implement the allocated private root dispatch after docs import; prove actual PF20 pair/typed ambiguity/cleanup and all25 predecessor checks, reviews35/36, then combined receiving proof. Compatibility37f23b991 received with25exits+suite0; protected-user/PF26 policy1.7 gates remain.
