...
- [ ] Review the [sealed-image preparation proposal](../../../../qa/security-levels/sprints/PF-27-S04/sealed-image-next-20260912.md) before implementation; then separately allocate exec binding/loader trust/spawn/supervision before listener/client wiring. Preserve identity/group/FD/Child rules and bounded resource handling; exact privileged installation approval and native qualification remain required.
