...
archived with final-tree evidence. PF-13-S03 is the sole `in_progress` sprint.
All later records are `draft` and cannot execute until their listed dependencies
are completed and archived.

| Order | Sprint | Outcome | Status | Depends on |
| ---: | --- | --- | --- | --- |
| 11 | [PF-13-S03](pf-13-s03-openai-exact-host-proxy-substitution.md) | Exact OpenAI proxy substitution | in progress | PF-13-S02 |
