...
remain `draft` until their listed dependencies are completed and archived.

| Order | Sprint | Outcome | Status | Depends on |
| ---: | --- | --- | --- | --- |
| 9 | [PF-13-S01](pf-13-s01-vault-backed-exact-host-credential-substitution.md) | Typed credential capability/store | ready | PF-16-S01, PF-17-S01, PF-19-S01, PF-22-S01 |
