...
| `PF-45` (`CSA-04`) | Legacy/conflict migration plus failure, recovery, and resume UX | [CSA-04 / PF-45-S01](../../sprints/current/claude-subscription-auth/pf-45-s01-auth-choice-and-recovery.md) | in progress; depends on PF-43-S01 and PF-44-S01 |
