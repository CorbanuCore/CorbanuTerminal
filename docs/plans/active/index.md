...
At most two plan files may declare `status: active`.

Current active initiatives:

- [P0 `/security` levels](p0-security-levels.md)
- [Unified provider onboarding and management](unified-provider-auth.md)
