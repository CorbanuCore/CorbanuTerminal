...
| `PF-49` | Shared metadata status and persisted eligibility | [PF-49-S01](../../sprints/current/unified-provider-auth/pf-49-s01-status-and-eligibility.md) | in progress |
