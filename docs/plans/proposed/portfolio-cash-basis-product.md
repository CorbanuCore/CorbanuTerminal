---
title: "Cash management and basis-strategy paper validation"
status: draft
...
# Cash management and basis-strategy paper validation
...
- Gate: Alex supplies the intended strategy and venue assumptions; no live trial without explicit separate limits and qualified review.

## User pain

The cash/basis idea needs a reproducible strategy definition, loss scenarios and exit rules before any live product or use of personal capital.

## Product intent and ideal flow

Build a research specification and paper-only evaluation that exposes funding, basis, liquidation, custody and withdrawal risk.
...
- Feature: **PF-69**; outcome: Build a research specification and paper-only evaluation that exposes funding, basis, liquidation, custody and withdrawal risk.
- Source: transcript discussion at 01:24:37–01:31:00; 02:26:45–02:28:15; see portfolio for attribution caveats.
...
- In: Strategy and risk contract; Reproducible paper and stress evaluation; Personal pilot versus product decision.
- Out: Executing Alex's trade, allocating user capital, yield guarantees, borrowing, leverage activation, deposits or pooled customer funds.
...
| --- | --- | --- | --- | --- |
| Alex Good (strategy owner, proposed) | UNALLOCATED | UNALLOCATED | UNALLOCATED | PF-69; one sprint at a time |
...
All records belong to the single feature **PF-69**. Dependencies are hard prerequisites, not suggestions. All results are pending.

| Sprint | Record / outcome | Depends on | Planned output | Evidence |
| --- | --- | --- | --- | --- |
| PF-69-S01 | [Strategy and risk contract](../../sprints/current/portfolio-cash-basis-product/pf-69-s01-strategy-and-risk-contract.md) | none | docs/research/cash-basis-product/strategy.md | pending |
| PF-69-S02 | [Reproducible paper and stress evaluation](../../sprints/current/portfolio-cash-basis-product/pf-69-s02-reproducible-paper-and-stress-evaluation.md) | PF-69-S01 | docs/research/cash-basis-product/paper-results.md | pending |
| PF-69-S03 | [Personal pilot versus product decision](../../sprints/current/portfolio-cash-basis-product/pf-69-s03-personal-pilot-versus-product-decision.md) | PF-69-S02 | docs/research/cash-basis-product/decision.md | pending |

## Acceptance flows

| Flow | Starting state / action | Expected result and pass criterion |
| --- | --- | --- |
| Success | Approved inputs; execute bounded sprint sequence | The paper report explains net returns and losses under historical and stressed assumptions with reproducible inputs. |
| Failure/cancel | Missing input, rejected gate or interrupted work | Funding reversal, basis widening, leg mismatch, liquidation, exchange outage or blocked withdrawal are measured failure scenarios. |
| Recovery/resume | Reopen from a recorded checkpoint | Resume a paper run from its ledger; reconcile both legs and cash rather than assuming a restart closes exposure. |

## Implementation sequence

1. **Strategy and risk contract:** A second analyst can implement the same strategy without guessing instrument or leverage choices.
2. **Reproducible paper and stress evaluation:** Both favorable and loss scenarios are reported; all results reproduce from the same data and code.
3. **Personal pilot versus product decision:** No research result is treated as authority to trade or market a yield product.
...
- Alex supplies the intended strategy and venue assumptions; no live trial without explicit separate limits and qualified review.
