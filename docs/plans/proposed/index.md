...
| --- | --- | --- | --- |
| [Prompt-injection firewall and brokered authority](prompt-injection-firewall.md) | P0 | Jim Ricketts | Grounds the Ambient-inspired secret broker, browser isolation, source labeling, classifier, Agent Sweep, and adversarial harness against current code and market references |
